...
export default function ResumePage() {
  ...
  const runFetchLatest = async () => {
    ...
    try {
      const response = await getResume(effectiveUserId || null);
      setResumeResponse(response);
        ...
        <section className="rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(18,24,38,0.96),rgba(8,11,20,0.95))] p-4 shadow-[0_30px_80px_rgba(0,0,0,0.35)] sm:rounded-[30px] sm:p-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-base leading-8 text-slate-300">Resume Intelligence is a paid-only add-on. Session-pack and premium users can generate, improve, fetch, preview, and download resumes here.</p>
            </div>
                  ...
                  <div className="rounded-[22px] border border-amber-300/20 bg-amber-300/10 p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-base text-slate-100">Upgrade to unlock resume generation and PDF download.</p>
                        <p className="mt-2 text-sm leading-6 text-slate-300">Free users can view the workspace, but generate, improve, fetch, and download actions stay disabled until a paid plan is active.</p>
                        <button
                          type="button"
                        ...
                        >
                          Upgrade for Resume Intelligence
                        </button>
                      </div>
                    </div>
                  </div>
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-300 sm:text-base">
                    {preview
                      ...
                      : hasResumeAccess
                        ...
                        : "Resume actions are disabled on free access. Upgrade to unlock the paid resume workflow."}
                  </p>
                </div>
                {resumeResponse && (
